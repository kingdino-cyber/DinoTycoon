...
const LOBBY_SHOP = {
  skins: [
    ...
    { id:'orange',    name:'Blaze Rex',      cost:350,  color:'#ff6b00', spike:'#b34000', desc:'Forged in wildfire.' },
    { id:'midnight',  name:'Midnight Dino',  cost:700,  color:'#1a1a2e', spike:'#e94560', desc:'Strikes from the shadows.' },
    { id:'arctic',    name:'Arctic Rex',     cost:450,  color:'#cce8ff', spike:'#4488bb', desc:'Born in the frozen tundra.' },
    { id:'toxic',     name:'Toxic Raptor',   cost:550,  color:'#39ff14', spike:'#007700', desc:'Dripping with prehistoric venom.' },
    { id:'crimson',   name:'Crimson Terror', cost:900,  color:'#8b0000', spike:'#ff2222', desc:'The most feared predator alive.' },
    { id:'galaxy',    name:'Galaxy Dino',    cost:1200, color:'#2d1b69', spike:'#a855f7', desc:'Descended from the stars.' },
    { id:'rust',      name:'Rust Stomper',   cost:200,  color:'#b55a30', spike:'#6b2d0f', desc:'Old but still dangerous.' },
    { id:'mint',      name:'Mint Rex',       cost:120,  color:'#3eb489', spike:'#1a5e40', desc:'Fresh and fast.' },
  ],
  tags: [
    ...
    { id:'blaze',   name:'Blaze',       cost:300,  prefix:'🔥 ' },
    { id:'ancient', name:'Ancient',     cost:400,  prefix:'[ANCIENT] ' },
    { id:'raptor',  name:'Raptor',      cost:150,  prefix:'🦖 ' },
    { id:'apex',    name:'Apex',        cost:1000, prefix:'[APEX] ' },
    { id:'ghost',   name:'Ghost',       cost:600,  prefix:'👻 ' },
    { id:'legend',  name:'Legend',      cost:2000, prefix:'[LEGEND] ' },
    { id:'dread',   name:'Dreadnought', cost:800,  prefix:'[DREAD] ' },
    { id:'toxic',   name:'Toxic',       cost:350,  prefix:'☠️ ' },
  ]
};
